(function (app) {
    ...
    app.LoadingServiceComponent = ng.core
        .Component({
			...
			template: '<div class="modal" tabindex="-1" role="dialog" style="text-align:center;margin-top:180px;" scroll="no" id="pleaseWaitDialog" data-backdrop="static" data-bs-backdrop="static" data-keyboard="false">'+
